...
class ViewController: UIViewController {
    ...
    lazy var oldPasswordField: UITextField = configurePasswordField(placeholderText: "Старый пароль", yPossition: 580)
    lazy var newPasswordField: UITextField = configurePasswordField(placeholderText: "Новый пароль", yPossition: 646)
    ...
    lazy var accountImageView: UIImageView = {
        ...
        $0.frame = CGRect(x: 30, y: 189, width: 100, height: 100)
    ...
    lazy var nameAndSurnameLabel: UILabel = {
        ...
        $0.frame = CGRect(x: 146, y: 208, width: 140, height: 19)
        return $0
    }(UILabel())
    ...
    lazy var editingButton: UIButton = {
        ...
        $0.frame = CGRect(x: 146, y: 236, width: 147, height: 34)
    ...
    lazy var addDescriptionLabel: UILabel = {
        ...
        $0.frame = CGRect(x: 30, y: 341, width: 160, height: 19)
        return $0
    }(UILabel())
    
    lazy var descriptionTextView: UITextView = {
        $0.backgroundColor = .systemGray5
        $0.frame = CGRect(x: 30, y: 369, width: view.frame.size.width - 60, height: 150)
    ...
    lazy var changePasswordLabel: UILabel = {
        ...
        $0.frame = CGRect(x: 30, y: 552, width: 145, height: 19)
        return $0
    }(UILabel())
    ...
    lazy var saveButton: UIButton = {
        ...
        $0.backgroundColor = .blue
        $0.layer.cornerRadius = 10
        $0.frame = CGRect(x: 30, y: 760, width: view.frame.size.width - 60, height: 55)
